...
const stats = [
  { label: 'Total Viewers', value: '0', icon: ViewersIcon },
  { label: 'Revenue', value: '$0', icon: RevenueIcon },
  { label: 'Comments', value: '0', icon: CommentsIcon },
  { label: 'Streams', value: '0', icon: StreamsIcon }
]
